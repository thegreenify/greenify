...
const rows =[]
  ...
  return (
    <div style={{ paddingBottom: 50 }}>
      ...
      >
        <p className="summary">Allottees Summary</p>
        <div style={{ display: "flex" }}>
          <div className="total">
            <h2 style={{ padding: "20px 0" }}>{state.length}</h2>
            <p style={{ padding: "20px 0" }}>Total Allottee</p>
          </div>
          <div className="total">
            <h2 style={{ padding: "20px 0" }}>1</h2>
            <p style={{ padding: "20px 0" }}>Active Allottee</p>
          </div>
          <div className="total">
            <h2 style={{ padding: "20px 0" }}>1</h2>
            <p style={{ padding: "20px 0" }}>Inactive Allottee</p>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        >
{/* <Link to="/add-allottee" style={{"textDecoration":"none"}}> */}
<Link to="/add-allottee" style={{"textDecoration":"none"}}>
