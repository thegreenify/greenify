...
const Division = ({ state }) => {
  ...
  const data = state.filter(
    (item) => item.divisionName != null || item.divisionName != undefined
  );
  ...
  return (
    <div style={{ paddingBottom: 50 }}>
      ...
      >
        <p className="summary">Division Summary</p>
        <div style={{ display: "flex" }}>
          <div className="total">
            <h2 style={{ padding: "20px 0" }}>{state.length}</h2>
            <p style={{ padding: "20px 0" }}>Total Division</p>
          </div>
          <div className="total">
            <h2 style={{ padding: "20px 0" }}>1</h2>
            <p style={{ padding: "20px 0" }}>Active Division</p>
          </div>
          <div className="total">
            <h2 style={{ padding: "20px 0" }}>1</h2>
            <p style={{ padding: "20px 0" }}>Inactive Division</p>
          </div>
        </div>
      </div>
      <div
          ...
          <div className="modal-content">
            ...
            >
              ...
              <div className="input-style" style={{ width: 250 }}>
                ...
                <input
                  onChange={(e) =>
                    setArea({ ...area, divisionName: e.target.value })
                  }
                />
              </div>
            </div>
